...
namespace Entidades
{
    public class E_Ventas
    {
        ...
        private List<E_DetalleVenta> Detalle;
        #endregion

        #region Constructor
        public E_Ventas(string accion, int idVenta, string codVenta, DateTime fecha, int idCliente, int cantidadProducto, string total)
        {
            _Accion = accion;
            _IdVenta = idVenta;
            _CodVenta = codVenta;
